...
export const MISCHIEF_COMMISSION_RECIPIENT = "0x39ee291682e829771ad0c3ed46ebc69a962b7c2f9e6477409b22616bcf21ac34";
...
export function verifiedReferralRecord(input, tx) {
  ...
  return {
    ...
    commissionRecipient: MISCHIEF_COMMISSION_RECIPIENT,
    paymentStatus: "due",
  };
}
