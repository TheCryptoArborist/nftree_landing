...
const RPC_URL = environmentValue("SUI_JSON_RPC_URL") || "https://fullnode.mainnet.sui.io:443";
...
export function createReferralHandler({
  getReferralStore = () => getStore({ name: "nftree-referrals", consistency: "strong" }),
  fetchTransactionImpl = fetchTransaction,
  verifySignature = personalMessageVerifier(),
  context = () => environmentValue("CONTEXT"),
} = {}) {
